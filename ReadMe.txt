========================================================================
    CONSOLE APPLICATION : Tiff Project Overview
========================================================================

AppWizard has created this Tiff application for you.

This file contains a summary of what you will find in each of the files that
make up your Tiff application.
...
StdAfx.h, StdAfx.cpp
    ...
    named Tiff.pch and a precompiled types file named StdAfx.obj.
...
HWND getHWND(string text)
{
	...
	while ( cont == true )
	{
		HWND hWnd = FindWindow(NULL,"Bluestacks App Player"); 
		if (hWnd != 0)
		{
